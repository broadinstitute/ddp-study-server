...
public class HomePage extends DDPPage {
    ...
    private static final String HOMEPAGE_INTRODUCTION_ARROW_XPATH = "//div[contains(@class, 'Intro-arrow')]//a";
    ...
    private static final String HOMEPAGE_TELL_US_ABOUT_YOURSELF_COUNT_ME_IN_LINK_XPATH = "(//div[contains(@class, 'row')]"
            + "//a[contains(@href, '/count-me-in')])[1]";
    private static final String HOMEPAGE_HOW_YOU_CAN_PARTICIPATE_COUNT_ME_IN_BUTTON_XPATH = "(//div[contains(@class, 'row')"
            + "]//a[contains(@href, '/count-me-in')])[2]";
    private static final String HOMEPAGE_PLEASE_JOIN_US_COUNT_ME_IN_BUTTON_XPATH = "(//div[contains(@class, 'row')]"
            + "//a[contains(@href, '/count-me-in')])[3]";
    ...
    private static final String FOOTER_JOIN_MAILING_LIST_LINK_XPATH = "//span[contains(@class, 'Footer-navItem')]"
    ...
    private static final String FOOTER_INFORMATION_FOR_PHYSICIANS_LINK_XPATH = "//a[@class='Footer-navItemLink']"
            + "[contains(text(), 'Information for Physicians')]";
    private static final String FOOTER_BACK_TO_TOP_LINK_XPATH = "//span[@class='Footer-navItemLink'][contains(text(), 'Back to top')]";

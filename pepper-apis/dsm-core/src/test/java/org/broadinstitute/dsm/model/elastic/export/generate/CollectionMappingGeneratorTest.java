...
public class CollectionMappingGeneratorTest {
    ...
    public void generate() {
        ...
        List<NameValue> nameValues = Arrays.asList(
                new NameValue("m.name", "Garden Grove Hospital & Medical Center"),
                new NameValue("m.phone", "123-456-7849"),
        ...
        Map<Object, Object> fieldsLevel = Map.of(
                "name", TypeParser.TEXT_KEYWORD_MAPPING,
                "phone", TypeParser.TEXT_KEYWORD_MAPPING,
                "fax", TypeParser.TEXT_KEYWORD_MAPPING
        );
        Map<String, Object> medicalRecord = Map.of(
                "medicalRecord", Map.of(
                        MappingGenerator.TYPE, MappingGenerator.NESTED,
                        MappingGenerator.PROPERTIES, fieldsLevel
                )
        );

...
public class UPSPackageTest {
    ...
    UPSActivity LABEL_GENERATED = new UPSActivity((UPSLocation) null, new UPSStatus("M", "Shipper created a label, UPS has not received "
            + "the package yet", "MP"), "20200910", "114203", null, null, null);
    UPSActivity DELIVERED = new UPSActivity((UPSLocation) null, new UPSStatus("D", "Delivered", "KB"), "20200913", "114203", null, null,
            null);
    UPSActivity IN_TRANSIT = new UPSActivity((UPSLocation) null, new UPSStatus("I", "Departed from Facility", "MP"), "20200912", "114203"
            , null, null, null);

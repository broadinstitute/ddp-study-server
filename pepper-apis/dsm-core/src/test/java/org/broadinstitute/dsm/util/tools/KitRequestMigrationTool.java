...
//                insertIntoDB(cfg.getString(ApplicationConfigConstants.INSERT_KIT_REQUEST), cfg.getString(ApplicationConfigConstants
//                .INSERT_KIT),
...
//                            line.get(BSP_PARTICIPANT_ID), line.get(BSP_PARTICIPANT_ID) , DBUtil.getLong(line.get(SHIPPED)), DBUtil
//                            .getLong(line.get(DBUtil.RECEIVED)),
...
//                            bspCollaboratorSampleType, collaboratorIdPrefix, DBUtil.getLong(line.get(SHIPPED)), DBUtil.getLong(line.get
//                            (DBUtil.RECEIVED)),
//                            line.get(TRACKING_TO), line.get(TRACKING_RETURN));
//                }
//            }
//        }
    ...
    private static void insertIntoDB(String insertKitRequestQuery, String insertKitQuery, String ddpParticipantId, String shortId,
        ...
        inTransaction((conn) -> {
            try {
                String collaboratorParticipantId = KitRequestShipping.generateBspParticipantID(collaboratorIdPrefix,
                        bspCollaboratorParticipantLength, shortId);

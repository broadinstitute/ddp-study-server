...
//        TransactionWrapper.reset(TestUtil.UNIT_TEST);
        ...
        String medicalRecordId = DBTestUtil.getQueryDetail(MedicalRecordMigrationTool.SQL_SELECT_MEDICAL_RECORD_INFORMATION + " and inst"
                + ".ddp_institution_id = \"40324\"", "20160", "medical_record_id");
        ...
        medicalRecordId = DBTestUtil.getQueryDetail(MedicalRecordMigrationTool.SQL_SELECT_MEDICAL_RECORD_INFORMATION + " and inst"
                + ".ddp_institution_id = \"40347\"", "20164", "medical_record_id");
        ...
        medicalRecordId = DBTestUtil.getQueryDetail(MedicalRecordMigrationTool.SQL_SELECT_MEDICAL_RECORD_INFORMATION + " and inst"
                + ".ddp_institution_id = \"40390\"", "20170", "medical_record_id");
        valueFromDB = DBTestUtil.getQueryDetail(RouteTest.SELECT_DATA_MEDICALRECORD_QUERY, medicalRecordId, "fax_sent");

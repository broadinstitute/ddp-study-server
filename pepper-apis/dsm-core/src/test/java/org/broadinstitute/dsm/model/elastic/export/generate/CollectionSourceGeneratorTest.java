...
public class CollectionSourceGeneratorTest {
    ...
    public void generate() {
        ...
        Map<String, Object> expected = Map.of(
                SourceGenerator.DSM_OBJECT, Map.of(
                        "medicalRecord", List.of(new LinkedHashMap<>(Map.of(
                                "name", "Garden Grove Hospital & Medical Center",
                                "fax", "123-456-7849",
                                "phone", "123-456-7849",
                                "medicalRecordId", "1000"
                        ))
                ))
        );
        ...
        assertEquals(
                Arrays.asList(actualName, actualFax, actualPhone),
                Arrays.asList(expectedName, expectedFax, expectedPhone)
        );
    }

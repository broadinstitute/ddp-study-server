...
public class RouteTestAbstraction extends TestHelper {
    ...
    public void getFormControls() throws Exception {
        ...
        HttpResponse response =
                TestUtil.performGet(DSM_BASE_URL, "/ui/abstractionformcontrols?realm=" + TEST_DDP, testUtil.buildAuthHeaders())
                        .returnResponse();
    ...
    public void addGroup() throws Exception {
        ...
        response = TestUtil.performGet(DSM_BASE_URL, "/ui/abstractionformcontrols?realm=" + TEST_DDP, testUtil.buildAuthHeaders())
                .returnResponse();
        assertEquals(200, response.getStatusLine().getStatusCode());
        Gson gson = new GsonBuilder().create();
        AbstractionGroup[] abstractionGroups = gson.fromJson(DDPRequestUtil.getContentAsString(response), AbstractionGroup[].class);
    ...
    private void addField(@NonNull String groupName, @NonNull String fieldName, @NonNull String fieldType, int orderNumber)
            throws Exception {
        //get group id
        List strings = new ArrayList<>();
        strings.add(TEST_DDP);
    ...
    public void abstraction() throws Exception {
        abstraction("abstraction", "{\\\"dateString\\\":\\\"1966-03-25\\\",\\\"est\\\":true}",
                "{\"dateString\":\"1966-03-25\",\"est\":true}");
        abstraction("review", "{\\\"dateString\\\":\\\"1966-03-02\\\",\\\"est\\\":true}", "{\"dateString\":\"1966-03-02\",\"est\":true}");
        //TODO start qc now
    }

    public void abstraction(@NonNull String activityName, @NonNull String abstractionUniqueValue, @NonNull String abstractionUniqueValue2)
            throws Exception {
    ...
    private AbstractionWrapper getAbstractionFields(@NonNull String ddpParticipantId, @NonNull String realm) throws Exception {
        ...
        AbstractionWrapper abstractionWrapper =
                new GsonBuilder().create().fromJson(DDPRequestUtil.getContentAsString(response), AbstractionWrapper.class);

...
public class NestedUpsertPainlessFacadeTest {
    ...
    private UpsertPainlessFacade getUpsertFacadePainless() {
        ...
        DDPInstanceDto ddpInstanceDto = new DDPInstanceDto.Builder()
                .build();
        UpsertPainlessFacade painlessFacade = new NestedUpsertPainlessFacade(kitRequestShipping, ddpInstanceDto,
                ESObjectConstants.KIT_LABEL, ESObjectConstants.KIT_LABEL,
    ...
    public void buildQueryBuilderForRemoveNestedCohortTagId() {
        ...
        DDPInstanceDto ddpInstanceDto = new DDPInstanceDto.Builder().build();
        NestedUpsertPainlessFacade painlessFacade = new NestedUpsertPainlessFacade(
                cohortTag, ddpInstanceDto, ESObjectConstants.DSM_COHORT_TAG_ID, ESObjectConstants.DSM_COHORT_TAG_ID, cohortTagId,
                new MockFieldTypeExtractor(),
        ...
        BoolQueryBuilder boolQueryBuilder = new BoolQueryBuilder();
        TermQueryBuilder cohortTagIdTerm = new TermQueryBuilder(String.join(
                DBConstants.ALIAS_DELIMITER, ESObjectConstants.DSM, ESObjectConstants.COHORT_TAG, ESObjectConstants.DSM_COHORT_TAG_ID
        ), cohortTagId);

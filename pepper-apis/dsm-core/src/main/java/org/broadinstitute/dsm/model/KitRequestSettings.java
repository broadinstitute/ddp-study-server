...
public class KitRequestSettings {
    ...
    private static final String SQL_SELECT_CARRIER =
            "SELECT dkc.kit_type_id, kt.kit_type_name, kt.customs_json, ddp_instance_id, cs_to.carrier as carrierTo, "
                    + "cs_to.easypost_carrier_id as carrierToId, cs_to.carrier_account_number as carrierToAccountNumber, cs_to.service as"
                    + " serviceTo, cs_return.carrier as carrierReturn, cs_return.easypost_carrier_id as carrierReturnId, "
                    + "cs_return.carrier_account_number as carrierReturnAccountNumber, cs_return.service as serviceReturn, "
                    + "dim.kit_height, dim.kit_weight, dim.kit_length, dim.kit_width, "
                    + "dkc.collaborator_sample_type_overwrite, dkc.collaborator_participant_length_overwrite, ret.return_address_name, "
                    ...
                    + "dkc.external_name, dkc.external_client_id, subK.kit_type_id, subK.external_name, subK.kit_count, "
    ...
    public KitRequestSettings(String carrierTo, String carrierToId, String serviceTo, String carrierToAccountNumber, String carrierReturn,
                              ...
                              String width, String weight, String collaboratorSampleTypeOverwrite,

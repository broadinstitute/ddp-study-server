...
public class AgreementValueProvider implements ValueProvider{
    ...
    public Collection<String> getValue(String esPath, Map<String, Object> esDataAsMap, Alias key, Filter column) {
        Collection<?> nestedValue =
                getNestedValue(column.getParticipantColumn().getName(), esDataAsMap, key, column.getParticipantColumn());

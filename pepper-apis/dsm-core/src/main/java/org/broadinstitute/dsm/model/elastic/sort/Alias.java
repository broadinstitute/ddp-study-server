...
public enum Alias {
    ...
    STATUS(StringUtils.EMPTY, false), PROFILE(StringUtils.EMPTY, false), ADDRESS(StringUtils.EMPTY, false),
    INVITATIONS(ElasticSearchUtil.INVITATIONS, false), PROXY(ElasticSearchUtil.PROFILE, false),

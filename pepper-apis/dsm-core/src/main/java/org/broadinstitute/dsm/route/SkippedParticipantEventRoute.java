    ...
    public Object processRequest(Request request, Response response, String userId) throws Exception {
        ...
        if (StringUtils.isNotBlank(realm)) {
            if (UserUtil.checkUserAccess(realm, userId, "participant_event", null)) {
                return SkippedParticipantEvent.getSkippedParticipantEvents(realm);
            } else {
                response.status(500);
        ...
        if (requestBody != null) {
            ...
            if (UserUtil.checkUserAccess(realm, userId, "participant_event", null)) {
                ...
                SkippedParticipantEvent.skipParticipantEvent(ddpParticipantId, currentTime, userIdRequest, instance, eventType);

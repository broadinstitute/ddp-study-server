...
public class Drug {
    ...
    private static final String SQL_SELECT_DRUGS_ALL_INFO = "SELECT drug_id, display_name, generic_name, brand_name, chemocat2, "
            + "chemo_type, study_drug, " +
            "treatment_type, chemotherapy, active FROM drug_list ORDER BY display_name asc";
    private static final String SQL_UPDATE_DRUG = "UPDATE drug_list SET display_name = ?, generic_name = ?, brand_name = ?, chemocat2 = "
            + "?, chemo_type = ?, " +
            "study_drug = ?, treatment_type = ?, chemotherapy = ?, active = ?, date_updated = ?, changed_by = ? WHERE drug_id = ?";
    private static final String SQL_INSERT_DRUG = "INSERT INTO drug_list SET display_name = ?, generic_name = ?, brand_name = ?, "
            + "chemocat2 = ?, " +

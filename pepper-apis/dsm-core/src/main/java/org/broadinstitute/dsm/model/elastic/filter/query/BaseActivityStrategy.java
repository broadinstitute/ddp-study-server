...
public abstract class BaseActivityStrategy extends BaseQueryStrategy {
    ...
    public BaseActivityStrategy(Operator operator, BaseQueryBuilder baseQueryBuilder, Parser parser) {
        this.operator = operator;
        this.baseQueryBuilder = baseQueryBuilder;
        this.parser = parser;
    }

    public static BaseActivityStrategy of(Parser parser,
        ...
        BaseActivityStrategy strategy = new ActivityStrategy(parser, operator, baseQueryBuilder);

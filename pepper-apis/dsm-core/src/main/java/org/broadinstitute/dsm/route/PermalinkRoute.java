...
////            try (PreparedStatement stmt = conn.prepareStatement(MedicalRecord.SQL_SELECT_MEDICAL_RECORD_INFORMATION
////            + QueryExtension.BY_INSTITUTION_ID)) {
...
////        }
////
////        if (medicalRecord != null && instance != null && StringUtils.isNotBlank(ddpInstitutionId)
////        && StringUtils.isNotBlank(ddpParticipantId)) {
...
////
////        public MedicalRecordAndInstance(DDPInstance ddpInstance, MedicalRecord medicalRecord, String ddpInstanceId,

...
public class ParticipantExit {
    ...
    private static final String SQL_SELECT_EXITED_PT =
            "SELECT realm.instance_name, ex.ddp_participant_id, u.name, ex.exit_date, ex.in_ddp " +
    ...
    private static final String SQL_INSERT_EXIT_PT =
            "INSERT INTO ddp_participant_exit (ddp_instance_id, ddp_participant_id, exit_date, exit_by, in_ddp) " +
                    "VALUES (?,?,?,?,?)";

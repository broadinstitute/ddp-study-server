...
public class DSMServer {
    ...
    private void setupPubSubPublisherRoutes(Config config) {
        ...
        GetClinicalOrdersForTissuesRoute ordersForTissueRoute = new GetClinicalOrdersForTissuesRoute();
        get(UI_ROOT + RoutePath.GET_CLINICAL_ORDERS_FOR_TISSUE_ROUTE, ordersForTissueRoute, new JsonTransformer());
    }

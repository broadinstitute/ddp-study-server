...
public class AbstractionField {
    ...
    private static final String SQL_INSERT_FORM_FIELD =
            "INSERT INTO medical_record_abstraction_field SET display_name = ?, type = ?, additional_type = ?, possible_values = ?, help_text = ?, medical_record_abstraction_group_id = ?, ddp_instance_id = (SELECT ddp_instance_id from ddp_instance where instance_name = ?), order_number = ?";
    ...
    private static final String SQL_UPDATE_FORM_FIELD =
            "UPDATE medical_record_abstraction_field SET display_name = ?, type = ?, additional_type = ?, possible_values = ?, help_text = ?, order_number = ? WHERE medical_record_abstraction_field_id = ?";

...
public class AuthenticationRoute implements Route {
    ...
    public AuthenticationRoute(@NonNull Auth0Util auth0Util, @NonNull String jwtSecret, @NonNull String cookieSalt, @NonNull String cookieName, @NonNull UserUtil userUtil, String environment, @NonNull String auth0Domain,

...
public class ParticipantStatusRoute implements Route {
    //doesn't need to extend RequestHandler because that route goes into another before check
        ...
        if (StringUtils.isNotBlank(study) && StringUtils.isNotBlank(ddpParticipantId)) {
            ...
            if (ddpInstance != null) {
                ParticipantStatus participantStatus =
                        ParticipantStatus.getParticipantStatus(ddpParticipantId, ddpInstance.getDdpInstanceId());

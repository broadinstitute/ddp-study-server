...
public class KitType {
    ...
    private static final String SQL_SELECT_KIT_TYPES =
            "SELECT DISTINCT rel.external_shipper, type.kit_type_id, rel.kit_type_display_name, type.kit_type_name, type.manual_sent_track, rel.upload_reasons FROM ddp_kit_request_settings rel, kit_type type," +

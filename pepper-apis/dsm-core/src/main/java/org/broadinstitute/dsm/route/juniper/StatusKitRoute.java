...
public class StatusKitRoute implements Route {
    ...
    public Object handle(Request request, Response response) throws Exception {
        ...
        if (request.url().contains(RoutePath.STATUS_KIT_STUDY)) {
        ...
        if (request.url().contains(RoutePath.STATUS_KIT_JUNIPER_KIT_ID)) {
        ...
        if (request.url().contains(RoutePath.STATUS_KIT_PARTICIPANT_KIT_ID)) {

                    ...
                    new MessageReceiver() {
                        ...
                        public void receiveMessage(PubsubMessage message, AckReplyConsumer consumer) {
                            try {
                                ...
                                String ddpEventId = message.getAttributesOrThrow(HousekeepingLocal.DDP_EVENT_ID);
                                String ddpEventType = message.getAttributesOrThrow(HousekeepingLocal.DDP_EVENT_TYPE);
                                ...
                                TransactionWrapper.useTxn(TransactionWrapper.DB.HOUSEKEEPING, handle -> {
                                    ...
                                    if (jdbiMessage.shouldProcessMessage(ddpMessageId)) {
                                        ...
                                        log.info("Received ddp message {} of type/version {}/{} for event {} with text {}",
                                                ...
                                                attributes.get(HousekeepingLocal.DDP_EVENT_TYPE),

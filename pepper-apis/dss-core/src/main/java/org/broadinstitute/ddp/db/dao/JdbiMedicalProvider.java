...
public interface JdbiMedicalProvider extends SqlObject {
    ...
    @SqlUpdate(
            "insert into user_medical_provider (user_id, umbrella_study_id, institution_type_id,"
                    + " user_medical_provider_guid, institution_name, physician_name, city, state, country_address_info_id, "
                    + "postal_code, phone, legacy_guid, street)"
                    ...
                    + " :userMedicalProviderGuid, :institutionName, :physicianName, :city, :state, :countryId, :postalCode, "
    ...
    @SqlUpdate(
            "update user_medical_provider set institution_type_id = "
                    ...
                    + " country_address_info_id = :countryId"

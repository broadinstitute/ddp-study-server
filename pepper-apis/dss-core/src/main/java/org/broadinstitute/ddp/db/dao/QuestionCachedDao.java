...
public class QuestionCachedDao extends SQLObjectWrapper<QuestionDao> implements QuestionDao {
    ...
    @Override
    public JdbiDecimalQuestion getJdbiDecimalQuestion() {
        return delegate.getJdbiDecimalQuestion();
    }

    @Override
    public JdbiEquationQuestion getJdbiEquationQuestion() {
        return delegate.getJdbiEquationQuestion();
    }

...
public interface CopyConfigurationSql extends SqlObject {
    ...
    @SqlUpdate("insert into copy_answer_location (copy_location_id, question_stable_code_id, user_type)"
            + " select :locId, question_stable_code_id, :userType from question_stable_code"

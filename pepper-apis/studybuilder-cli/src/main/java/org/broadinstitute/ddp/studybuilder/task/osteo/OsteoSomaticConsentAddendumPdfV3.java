...
@Slf4j
public class OsteoSomaticConsentAddendumPdfV3 implements CustomTask {

    private static final String DATA_FILE = "patches/somatic-consent-addendum-pdfs-v3.conf";
    ...
    public void run(Handle handle) {
        log.info("Executing patch: OsteoSomaticConsentAddendumPdfV3");

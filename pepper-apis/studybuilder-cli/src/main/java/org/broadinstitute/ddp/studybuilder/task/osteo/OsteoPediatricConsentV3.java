...
@Slf4j
public class OsteoPediatricConsentV3 implements CustomTask {
    private static final String DATA_FILE = "patches/consent-pediatric-version-3.conf";
    ...
    public void run(Handle handle) {
        ...
        String activityCodeConsent = "PARENTAL_CONSENT";

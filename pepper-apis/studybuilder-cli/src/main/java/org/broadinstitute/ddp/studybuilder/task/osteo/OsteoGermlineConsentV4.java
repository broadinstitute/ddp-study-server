...
@Slf4j
public class OsteoGermlineConsentV4 extends RevisionStudyActivityVariablesSupportV2 {

    private static final String DATA_FILE = "patches/v4/germline-consent-v4.conf";
    ...
    private static final String ACTIVITY_NAME_ES = "Aprenda sobre su ADN con Genome Medical e Invitae";
    private static final String ACTIVITY_TITLE_ES =
            "Anexo al formulario de consentimiento:<br>Aprenda sobre su ADN con Genome Medical e Invitae";

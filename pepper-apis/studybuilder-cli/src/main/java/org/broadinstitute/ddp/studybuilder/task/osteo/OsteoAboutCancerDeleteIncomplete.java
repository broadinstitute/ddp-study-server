...
@Slf4j
public class OsteoAboutCancerDeleteIncomplete implements CustomTask {
    private static final List<String> ACTIVITY_CODES = List.of("ABOUTCHILD", "ABOUTYOU");
    ...
    public void run(Handle handle) {
        ...
        deleteIncompleteActivities();
    }

    private void deleteIncompleteActivities() {
        List<Long> activityInstances = helper.findAboutCancerActivityInstances(studyDto.getGuid(), ACTIVITY_CODES);
    ...
    private interface SqlHelper extends SqlObject {
        ...
        List<Long> findAboutCancerActivityInstances(@Bind("studyGuid")String studyGuid,

...
@Slf4j
public class LmsGermlineConsentVersion2 implements CustomTask {

    private static final String DATA_FILE = "patches/germline-consent-addendum-v2.conf";
    ...
    public void run(Handle handle) {
        ...
        runGermlineConsentUpdate(handle, metaConsent, version2ForConsent);
    }
    ...
    private void runGermlineConsentUpdate(Handle handle, RevisionMetadata meta, ActivityVersionDto version2) {

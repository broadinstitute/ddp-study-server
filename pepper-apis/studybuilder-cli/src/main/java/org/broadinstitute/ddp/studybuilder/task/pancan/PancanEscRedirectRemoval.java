...
@Slf4j
public class PancanEscRedirectRemoval implements CustomTask {
    ...
    public void run(Handle handle) {
        ...
        //find and delete the ESC study redirect workflow transition
        ...
        //update pex expressions to remove ESC (C_GASTRO_ESOPHAGEAL_CANCER, C_GASTRO_GASTRIC_STOMACH_CANCER)

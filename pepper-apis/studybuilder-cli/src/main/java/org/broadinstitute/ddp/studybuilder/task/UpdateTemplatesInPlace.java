...
public class UpdateTemplatesInPlace implements CustomTask {
    ...
    public void traverseSection(Handle handle, int sectionNum, Config sectionCfg, FormSectionDef section, long timestamp) {
    ...
    public void traverseQuestion(Handle handle, Config questionCfg, QuestionDef question, long timestamp) {

...
@Slf4j
public class MpcCompositeTreatmentQuestion implements CustomTask {
    ...
    public void run(Handle handle) {
        ...
        CompositeQuestionDef def = gson.fromJson(ConfigUtil.toJson(dataCfg.getConfig("compositeQuestion")),
                CompositeQuestionDef.class);

...
@Slf4j
public class LmsSomaticConsentPedVersion2 implements CustomTask {

    private static final String DATA_FILE = "patches/somatic-consent-addendum-ped-v2.conf";
    ...
    public void run(Handle handle) {
        ...
        activityUpdate(handle, metaConsent, activityVer2);
    }
    ...
    private void activityUpdate(Handle handle, RevisionMetadata meta, ActivityVersionDto version2) {
        ...
        updateQuestionTemplateVariables(meta, version2, dataCfg); //revision only variables in the Question Template
    }
    ...
    private void revisionContentBlockTemplate(Handle handle, RevisionMetadata meta, ActivityVersionDto versionDto, Config conf) {
        ...
        BlockContentDto contentBlock = handle.attach(LmsSomaticConsentPedVersion2.SqlHelper.class)
    ...
    private void updateQuestionTemplateVariables(RevisionMetadata meta,
        ...
        for (Config config : configList) {
            ...
            Long variableId = sqlHelper.findVariableIdByQuestion(templateVariable.getName(), "SOMATIC_ASSENT_ADDENDUM",
                    "CONSENT_ADDENDUM_PEDIATRIC", "cmi-lms");
    ...
    private void revisionVariableTranslation(TemplateVariable templateVariable,
        ...
        revisionVariable(templateVariable, meta, version2, templateVariableId);
    }

    private void revisionVariable(TemplateVariable templateVariable, RevisionMetadata meta,
                                  ActivityVersionDto version2, Long templateVariableId) {

...
@Slf4j
public class OsteoConsentVersion4 extends RevisionStudyActivityVariablesSupportV2 {
    private static final String DATA_FILE = "patches/v4/consent-version-4.conf";
    private static final String STUDY_LMS = "CMI-OSTEO";
    private static final String ACTIVITY_CODE = "CONSENT";

    public OsteoConsentVersion4() {

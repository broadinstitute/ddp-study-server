...
@Slf4j
public class LmsSomaticConsentVersion2 implements CustomTask {

    private static final String DATA_FILE = "patches/somatic-consent-addendum-v2.conf";
    ...
    private void revisionContentBlockTemplate(Handle handle, RevisionMetadata meta, ActivityVersionDto versionDto, Config conf) {
        ...
        BlockContentDto contentBlock = handle.attach(LmsSomaticConsentVersion2.SqlHelper.class)

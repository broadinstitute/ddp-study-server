...
public class DatePicklistDefTest {
    ...
    public void testUseAnchorYear() {
        DatePicklistDef config = new DatePicklistDef(null, 2, 50, 2018, null);
    ...
    public void testUseCurrentYear() {
        ...
        DatePicklistDef config = new DatePicklistDef(null, 2, 50, null, null);
    ...
    public void testUseDefaultYearsForward() {
        DatePicklistDef config = new DatePicklistDef(null, null, 50, 2000, null);
    ...
    public void testUseDefaultYearsBack() {
        DatePicklistDef config = new DatePicklistDef(null, 2, null, 2000, null);

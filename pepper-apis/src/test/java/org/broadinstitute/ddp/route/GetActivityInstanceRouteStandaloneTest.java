...
public class GetActivityInstanceRouteStandaloneTest extends IntegrationTestSuite.TestCaseWithCacheEnabled {
    ...
    public void testGet_matrixQuestion() {
        ...
        resp.then().assertThat()
                ...
                .body("matrixOptions[0].groupId", equalTo("DEFAULT"))
                .body("matrixOptions[1].stableId", equalTo("MA_SINGLE_OPT_2"))
                .body("matrixOptions[1].groupId", equalTo("MA_SINGLE_GROUP"))
                .body("matrixOptions[2].stableId", equalTo("MA_SINGLE_OPT_3"))
                .body("matrixOptions[2].groupId", equalTo("MA_SINGLE_GROUP"))
                .body("matrixQuestions.size()", equalTo(2))
                .body("matrixQuestions[0].stableId", equalTo("MA_SINGLE_ROW_1"))
                .body("matrixQuestions[1].stableId", equalTo("MA_SINGLE_ROW_2"));
        ...
        resp.then().assertThat()
                ...
                .body("groups[0].identifier", equalTo("MA_MULTI_GROUP"))
                .body("matrixOptions.size()", equalTo(3))
                .body("matrixOptions[0].stableId", equalTo("MA_MULTI_OPT_1"))
                .body("matrixOptions[0].groupId", nullValue())
                .body("matrixOptions[1].stableId", equalTo("MA_MULTI_OPT_2"))
                .body("matrixOptions[1].groupId", equalTo("MA_MULTI_GROUP"))
                .body("matrixOptions[2].stableId", equalTo("MA_MULTI_OPT_3"))
                .body("matrixOptions[2].groupId", equalTo("MA_MULTI_GROUP"))
                .body("matrixQuestions.size()", equalTo(2))
                .body("matrixQuestions[0].stableId", equalTo("MA_MULTI_ROW_1"))
                .body("matrixQuestions[1].stableId", equalTo("MA_MULTI_ROW_2"))

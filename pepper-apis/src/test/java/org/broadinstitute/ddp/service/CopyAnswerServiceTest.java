...
public class CopyAnswerServiceTest extends TxnAwareBaseTest {
    ...
    public void testCopyAnswerToProfileLastName() {
        TransactionWrapper.useTxn(handle -> {
            ...
            EventConfigurationDto eventConfig = new EventConfigurationDto(null, null, 0L, null, null, 0L, null, null,
                    EventActionType.COPY_ANSWER, 0L, false, false, textQuestionStableId, CopyAnswerTarget.PARTICIPANT_PROFILE_LAST_NAME);
    ...
    public void testCopyAnswerToProfileBirthDate() {
        TransactionWrapper.useTxn(handle -> {
            ...
            EventConfigurationDto eventConfig = new EventConfigurationDto(null, null, 0L, null, null, 0L, null, null,
                    EventActionType.COPY_ANSWER, 0L, false, false, dateQuestionStableId, CopyAnswerTarget.PARTICIPANT_PROFILE_BIRTH_DATE);
            copyService.copyAnswerValue(eventConfig, instance, 0L, handle);

...
public class QuestionDaoTest extends TxnAwareBaseTest {
    ...
    public void testDisableBoolQuestion() {
        TransactionWrapper.useTxn(handle -> {
            ...
            assertTrue(questionDto.isDeprecated());
    ...
    public void testDisableTextQuestion() {
        TransactionWrapper.useTxn(handle -> {
            ...
            assertTrue(jdbiQuestion.findQuestionDtoById(question.getQuestionId())
                    .map(QuestionDto::isDeprecated)
                    .orElse(false));
            assertFalse(jdbiTmpl.getRevisionIdIfActive(prompt.getTemplateId()).isPresent());
    ...
    public void testGetBooleanQuestion_cantFindById() {
        TransactionWrapper.useTxn(handle -> {
            ...
            handle.attach(QuestionDao.class).getBooleanQuestion(
                    (BooleanQuestionDto) questionDto,
                    activityInstanceDto.getGuid(),
    ...
    public void testGetPicklistQuestion_cantFindById() {
        TransactionWrapper.useTxn(handle -> {
            ...
            handle.attach(QuestionDao.class).getPicklistQuestion(
                    (PicklistQuestionDto) questionDto,
                    activityInstanceDto.getGuid(),
                    Collections.emptyList(),
                    Collections.emptyList());
    ...
    public void testGetDateQuestion_cantFindById() {
        TransactionWrapper.useTxn(handle -> {
            ...
            handle.attach(QuestionDao.class).getDateQuestion(
                    (DateQuestionDto) questionDto, activityInstanceDto.getGuid(), Collections.emptyList(),
                    Collections.emptyList());
        });
    }
    ...
    public void testGetCompositeQuestion_cantGetById() {
        TransactionWrapper.useTxn(handle -> {
            ...
            handle.attach(QuestionDao.class).getCompositeQuestion(
                    (CompositeQuestionDto) questionDto,
                    activityInstanceDto.getGuid(),
                    List.of(ans.getAnswerId()),
                    Collections.emptyList(),

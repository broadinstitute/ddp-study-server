...
/**     IMPORTANT
 * EOB: This file was originally created by Google (OAuthParameters) but it didn't allow for the inclusion of x_auth parameters
 * in the signature generation and it was final so the source code was retrieved from GitHub and edited slightly...
 */
 ...
 * @author Yaniv Inbar
 */
public final class AuthParams implements HttpExecuteInterceptor, HttpRequestInitializer {
    ...
    public void computeSignature(String requestMethod, GenericUrl requestUrl)
        ...
        putParameterIfValueNotNull(parameters, "x_auth_mode", xAuthMode);
        putParameterIfValueNotNull(parameters, "x_auth_password", xAuthPassword);
        putParameterIfValueNotNull(parameters, "x_auth_username", xAuthUsername);

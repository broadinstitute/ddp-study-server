...
public class GetStudyDetailRoute implements Route {
    ...
    public StudyDetail handle(Request request, Response response) {
        ...
        return TransactionWrapper.withTxn(handle -> {
            ...
            String name = preferredTranslation.map(StudyI18nDto::getName).orElse(study.getName());
            String summary = preferredTranslation.map(StudyI18nDto::getSummary).orElse(null);

...
import org.broadinstitute.ddp.service.actvityinstanceassembler.block.question.ValidationRuleCreator;
...
/**
 * Provides creation of {@link ActivityInstance} an alternative way:
 ...
 *
 * <p>Main method of this service is
 * {@link #assembleActivityInstance(Handle, String, ContentStyle, String, String, String, ActivityInstanceDto)}
 * which needs to be called for example from {@link GetActivityInstanceRoute}.
 ...
 * </ul>
 *
 * <p>For each element creation implemented creators (instances of interface {@link ElementCreator}.
 * <br>Element creators hierarchy:
 * <pre>
 ...
 * </pre>
 *
 * <p>NOTE: it is defined a class {@link Context} used to pass the basic parameters to each element creator (so it no
 * need to pass multiple parameter in each creator - only one parameter.
 */
public class ActivityInstanceAssembleService {

    public Optional<ActivityInstance> assembleActivityInstance(
            Handle handle,
            String isoLangCode,
            ContentStyle style,
            String studyGuid,
    ...
    /**
     * Aggregates objects which needs on all steps of an activity instance assembling.
     */

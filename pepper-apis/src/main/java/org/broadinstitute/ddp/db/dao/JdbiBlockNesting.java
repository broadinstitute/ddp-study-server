...
public interface JdbiBlockNesting extends SqlObject {
    ...
    @SqlQuery("select bt.block_type_code, nested.block_id, nested.block_guid, e.expression_text"
    ...
    @RegisterRowMapper(FormBlockDto.FormBlockDtoMapper.class)
    List<FormBlockDto> findOrderedNestedFormBlockDtosByBlockIdAndTimestamp(@Bind("blockId") long blockId,

...
public interface ContentBlockDao extends SqlObject {
    ...
    default Map<Long, ContentBlockDef> collectBlockDefs(List<FormBlockDto> blockDtos, long timestamp) {
        ...
        Map<Long, BlockContentDto> contentDtos = getJdbiBlockContent()
                .findDtosByBlockIdsAndTimestamp(blockIds, timestamp)
                .collect(Collectors.toMap(BlockContentDto::getBlockId, Function.identity()));

...
public class AgreementAnswerCopier extends BaseAnswerCopier {
    ...
    public AnswerCopyResult copyAnswer(Handle handle, long sourceInstanceId, String sourceQuestionStableId, long destinationInstanceId,
        ...
        handle.attach(ActivityAnswerCopierSql.class).copyAgreementAnswer(baseCopyResult.getSourceAnswerId(),

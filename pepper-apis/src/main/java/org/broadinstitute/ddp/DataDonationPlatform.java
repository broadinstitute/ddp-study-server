...
public class DataDonationPlatform {
    ...
    private static void start() {
        ...
        EmbeddedServers.add(
                ...
                new AppEngineServerFactory(new JettyServer(), cfg.getString(ConfigFile.PREFERRED_SOURCE_IP_HEADER)));
    ...
    private static void setupRateLimits(int maxRequestsPerSecond, int burst) {
    ...
    public static final class FilterConfig implements javax.servlet.FilterConfig {

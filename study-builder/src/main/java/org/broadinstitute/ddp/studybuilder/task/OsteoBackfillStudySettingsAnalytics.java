...
public class OsteoBackfillStudySettingsAnalytics implements CustomTask {

    private static final Logger LOG = LoggerFactory.getLogger(OsteoBackfillStudySettingsAnalytics.class);

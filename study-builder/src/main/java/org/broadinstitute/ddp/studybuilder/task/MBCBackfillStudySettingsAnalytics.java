...
public class MBCBackfillStudySettingsAnalytics implements CustomTask {

    private static final Logger LOG = LoggerFactory.getLogger(MBCBackfillStudySettingsAnalytics.class);

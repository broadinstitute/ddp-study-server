...
public class BrainBackfillStudySettingsAnalytics implements CustomTask {

    private static final Logger LOG = LoggerFactory.getLogger(BrainBackfillStudySettingsAnalytics.class);
